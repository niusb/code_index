...
-XX+PrintGCDetails：打印 gc 详情，包括 gc 前内存等。

-Xloggc..gclogsgc.log.date：指定 gc log 的路径
...
YGC 频繁
直接查看 gc log 并不直观，我们可以借用一些可视化工具来帮助我们分析，httpsgceasy.io是个挺不错的网站，我们把 gc log 上传上去后， gceasy 可以帮助我们生成各个维度的图表帮助分析。
...
这个问题我之前有提到，1.8 之后 JVM 对锁进行了优化，添加了偏向锁的概念，避免了很多不必要的加锁操作，但偏向锁一旦遇到锁竞争，取消锁需要进入 safe point，导致 STW。
...
————————————————
版权声明：本文为CSDN博主「码爱爸爸」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：httpsblog.csdn.netm0_58683072articledetails122675914